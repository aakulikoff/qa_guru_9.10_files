...
public class TestData {
    ...
    public static String UPLOADURL = "https://demoqa.com/upload-download";
    public static String FILENAME = "Pictures.JPG";
    public static String FILEPATH = "/Users/andrey/Desktop/FileName.txt";
